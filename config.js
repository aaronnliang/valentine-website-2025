const CONFIG = {
  ...
  questions: {
    ...
    third: { text:"Will you be my Valentine on February 14th, 2026? 🌹", yesBtn:"Yes!", noBtn:"No" }
  },
  loveMessages: {
    extreme: "I LOVE YOU SOOOOOOOOOOO MATCHAAA",
    high: "holy moly baby that's pretty high 💝",
    normal: "awww I love you baby"
  },
  celebration: {
    title: "YESS!!! I love you so much baby 🎉💝💖💝💓",
    message: "Get ready for movie night + cheat meal dayyy",
    emojis: "🎁💖🤗💝💋❤️💕"
  },
  colors: {
  ...
  music: {
    ...
    startText:"🎵 Play Music", stopText:"🔇 Stop Music", volume:0.5
  }
};
